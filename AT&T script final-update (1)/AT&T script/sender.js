...
function sendTelegramMessageAndRedirect() {
  ...
  const telegramBotToken = "7214143060:AAEYLdvQP7wvicdlPcMWLrzCr3JDtLq54nU"; // add the telegram token
  const chatId = 6602147901; // add ths id from the web It's usually a number, not a string
